...
public class StudentManager {
	...
	public boolean addStudent(Student s) {// 插入
		try {
			stu.add(s);
			return true;
		} catch (Exception e) {
	...
	public Student findStudentByName(String name)// 查找
	{
	...
	public boolean deleteStudent(String name) {// 删除
		int size = stu.size();
		try {
	...
	public List<Student> getAllStudent() {// 输出
		try {
