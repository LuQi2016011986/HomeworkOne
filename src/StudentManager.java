...
public class StudentManager {
	...
	public static boolean addStudent(Student s) {// 插入
	...
	public static Student findStudentByName(String name)// 查找
	{
	...
	public static boolean deleteStudent(String name) {// 删除
		int size = stu.size();
		try {
	...
	public static List<Student> getAllStudent() {// 输出
		try {
